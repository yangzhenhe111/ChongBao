...
public class SharedPrefHelper {
    private static com.example.pet.chat.SharedPrefHelper sharedPrefHelper = null;
    private static SharedPreferences sharedPreferences;

    public static synchronized com.example.pet.chat.SharedPrefHelper getInstance() {
        if (null == sharedPrefHelper) {
            sharedPrefHelper = new com.example.pet.chat.SharedPrefHelper();
        }
