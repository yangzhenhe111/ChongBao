...
public class ScanView extends View {
    ...
    private void initPaint() {
        ...
        mPaintCircleOrLine.setColor(getResources().getColor(R.color.colorTheme));
        ...
        mPaintArc2.setColor(getResources().getColor(R.color.colorTheme));
        ...
        mPaintLine.setColor(getResources().getColor(R.color.colorTheme));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        SweepGradient sweepGradient1 = new SweepGradient(mWidth / 2, mHeight / 2,
                new int[]{Color.TRANSPARENT, getResources().getColor(R.color.colorTheme)}, new float[]{0.8f, 1f});
        mPaintArc1.setShader(sweepGradient1);


        SweepGradient sweepGradient2 = new SweepGradient(mWidth / 2, mHeight / 2,
                Color.TRANSPARENT, getResources().getColor(R.color.colorTheme));
