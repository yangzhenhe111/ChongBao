    ...
    private Handler hd = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if(msg.what == CODE_TRUE){
                ...
                Intent intent = new Intent();
                intent.setClass(Update.this,Register.class);
                startActivity(intent);
                Update.this.finish();
...
//                        }
    ...
    private void toast(final String str) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(Update.this, str, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setView() {
        ...
        btnGetYan = findViewById(R.id.btn_getYan_find);
    ...
    private void insert() {
        ...
        Request request = new Request.Builder()
                .post(requestBody)
                .url(Cache.MY_URL + "UpdataPasswordServlet")
                .build();
